    ...
    return (
        <div className='flex flex-col gap-4'>
            <div className='flex items-center justify-center gap-2'>
                <p className='text-3xl sm:text-4xl md:text-5xl font-semibold text-blue-800'>{index}</p>
...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\'s', 'Huge', 'o\'clock']}>
            ...
            <div className='grid grid-cols-2 p-3.5 sm:grid-cols-4 gap-4 mb-5'>
            ...
            <div className='grid p-3.5 grid-cols-1 sm:grid-cols-3 mb-4 gap-4'>
